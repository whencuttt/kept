  ...
  return (
    <html lang="en"><body className="min-h-screen">
      <header className="border-b border-[var(--line)]"><div className="mx-auto max-w-5xl px-4 h-14 flex items-center justify-between">
        ...
        <nav className="flex gap-5 text-sm text-[var(--dim)]"><Link href="/q">asks</Link><Link href="/skill.md">skill.md</Link><Link href="/heartbeat.md">heartbeat.md</Link><a href="/api/v1/feed">api</a><a href="https://github.com/whencuttt/kept">source</a></nav>
      </div></header>
