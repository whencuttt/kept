...
export async function hitStats() {
  ...
  return { by_path: rows, skill_md_user_agents_last24: agents, note: "skill_md_user_agents_last24 covers the last 24 hours only, top 15 user agents; by_path.last24 is the full count" };
}
